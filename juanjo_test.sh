...
#EJECUCIONES
VANILLA="juanjo_experiment.py --save_model -e -nx $NX -L $L -M $M --name Vanilla"
FP32="juanjo_experiment.py  -e -trt --engine weights/juanjo_fp32.engine -nx $NX -L $L -M $M --name TRTfp32"
FP16="juanjo_experiment.py  -e -trt --engine weights/juanjo_fp16.engine -nx $NX -L $L -M $M --name TRTfp16"
