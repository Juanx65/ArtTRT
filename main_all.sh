...
NVIDIA_SMI_PID=$!
python main.py -v --batch_size=$BATCH_SIZE --dataset='datasets/dataset_val/val' --network="$NETWORK" --less --weights weights/yolov8n-cls.pt --engine weights/yolov8n-cls.engine --model_version "Vanilla"
kill $NVIDIA_SMI_PID
