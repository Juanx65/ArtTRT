...
kill $NVIDIA_SMI_PID
echo "VANILLA ENDS"
python3 post_processing/gpu_metrics_plotter.py --csv "$MONITOR_OUTPUT_VANILLA"
...
kill $NVIDIA_SMI_PID
echo "TRT FP32 ENDS"
python3 post_processing/gpu_metrics_plotter.py --csv "$MONITOR_OUTPUT_FP32"
...
kill $NVIDIA_SMI_PID
echo "TRT FP16 ENDS"
python3 post_processing/gpu_metrics_plotter.py --csv "$MONITOR_OUTPUT_FP16"
