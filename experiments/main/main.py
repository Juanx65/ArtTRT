...
def main(opt):
    ...
    if opt.validate:
        ...
        if opt.val_dataset:
            ...
            engine_path_1 = os.path.join(base_directory,"weights/best_fp32.engine")
            engine_path_2 = os.path.join(base_directory,"weights/best_fp16.engine")
            engine_path_3 = os.path.join(base_directory,"weights/best_int8.engine")
